...
class FacadeTest < Minitest::Test
  ...
  def test_has_mediator
    ...
    assert_equal true, facade.has_mediator?('facadeHasMediatorTest'),
                 "Expecting facade.has_mediator?('facadeHasMediatorTest')"

    facade.remove_mediator('facadeHasMediatorTest')

    # assert that the facade.hasMediator method returns false
    # for that mediator name
    assert_equal false, facade.has_mediator?('facadeHasMediatorTest'),
                 "Expecting facade.has_mediator?('facadeHasMediatorTest')"
  end
  ...
  def facade_has_command
    ...
    assert_equal true, facade.has_command?('facadeHasCommandTest'),
                 "Expecting facade.has_command?('facadeHasCommandTest')"
