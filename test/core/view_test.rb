...
class ViewTest < Minitest::Test
  ...
  def test_successive_register_and_remove_mediator
    ...
    assert_kind_of ViewTestMediator, view.retrieve_mediator(ViewTestMediator::NAME),
    ...
    assert_nil view.retrieve_mediator(ViewTestMediator::NAME),
               'Expecting view.retrieve_mediator(ViewTestMediator::NAME) == nil'

    # test that removing the mediator again once its gone doesn't cause crash
    assert_nil view.remove_mediator(ViewTestMediator::NAME),
  ...
  def test_remove_mediator_and_subsequent_notify
    ...
    # test that retrieving it now returns nil
    assert_nil view.retrieve_mediator(ViewTestMediator2::NAME),
               'Expecting view.retrieve_mediator(ViewTestMediator2.NAME) == nil'
  ...
  def test_mediator_reregistration
    ...
    # test that retrieving it now returns nil
    assert_nil view.retrieve_mediator(ViewTestMediator5::NAME),
               'Expecting view.retrieve_mediator(ViewTestMediator5::NAME) == nil'
...
class ViewTestMediator2 < Mediator
  ...
  def handle_notification(notification)
    component.last_notification = notification.name
  end
end
...
class ViewTestMediator4 < Mediator
  ...
  def on_register
    component.on_register_called = true
  end

  def on_remove
    component.on_remove_called = true
  end
end
